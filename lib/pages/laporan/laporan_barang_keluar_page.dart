...
class _LaporanBarangKeluarPageState extends State<LaporanBarangKeluarPage> {
  ...
  Future<void> loadData() async {
    ...
    try {
      final result = await LaporanService.getBarangKeluar(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Laporan Barang Keluar', style: TextStyle(fontSize: responsive.appBarFontSize)),
        backgroundColor: AppColors.laporanKeluar,
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: loadData,
                      style: ElevatedButton.styleFrom(backgroundColor: AppColors.laporanKeluar),
